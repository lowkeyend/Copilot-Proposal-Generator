        ...
        ProposalTemplate(
            ...
            sections=[
                TemplateSection(
                    ...
                    keywords=["summary", "upgrade", "outcome"],
                    description="Frame the technical upgrade scope, target state, and expected business outcome.",
                ),
                TemplateSection(
                    title="Introduction",
                    keywords=["introduction", "proprietary", "validity", "contact"],
                    description="Provide proposal context, notice language, validity, and contact framing.",
                ),
                TemplateSection(
                    title="Company Profile",
                    keywords=["company", "profile", "systems limited"],
                    description="Preserve the corporate profile and credentials section.",
                ),
                TemplateSection(
                    title="Scope of Work",
                    keywords=["scope", "work", "upgrade", "testing", "cutover"],
                    description="Define the technical upgrade scope, activities, and delivery boundaries.",
                ),
                TemplateSection(
                    title="Proposed Solution",
                    keywords=["solution", "target principles", "upgrade approach"],
                    description="Describe the target solution principles and upgrade execution approach.",
                ),
                TemplateSection(
                    title="Upgrade Methodology",
                    keywords=["tim", "methodology", "stages", "runbook"],
                    description="Explain the upgrade stages, controls, validation, and delivery method.",
                ),
                TemplateSection(
                    title="Project Timeline",
                    keywords=["timeline", "milestones", "schedule"],
                    description="Outline the delivery timeline and stage milestones.",
                ),
                TemplateSection(
                    title="Project Governance",
                    keywords=["governance", "communication", "quality", "escalation"],
                    description="Set out governance, reporting, quality, and escalation mechanisms.",
                ),
                TemplateSection(
                    title="Assumptions",
